        ...
        <div class="share">
          <ul>
           ...
           <li><a  href="https://www.facebook.com/sharer/sharer.php?u=<?php echo $page->url() ?>" onclick="window.open(this.href, 'facebook-share','width=580,height=296');return false;">Facebook</a></li> 
            <li><a href="https://twitter.com/share?text=<?php echo $page->title() ?>&amp;url=<?php echo $page->url() ?>" onclick="window.open(this.href, 'twitter-share', 'width=550,height=235');return false;">Twitter</a></li>
